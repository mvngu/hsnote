...
the person's systolic blood pressure.  If a person is $x = 70$ years
old, the regression
...
causes another value.  The word correlation is used in cases where one
thing~(e.g.~$B$) is observed to follow something else~(e.g.~$A$).
