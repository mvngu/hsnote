...
as saying that more hours spent studying for a test results in higher
test scores.  Other factors not given by the data might have
contributed to a student's test score.  For example, the students with
high or perfect test scores might have been studying every day since
