...
\item This problem will help you to derive~(again!) the quadratic
  formula by using a technique due to Fran\c{c}ois Vi\`ete.
  %%
  \begin{packedenum}
  \item\label{subprob:quadratic_roots:ax_square_minus_c}
...
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:quadratic_roots:ax_square_minus_c}
The roots of $f(x)$ are all values of $x$ such that the expression
$f(x) = 0$ is true.  That is, you want all values of $x$ such that the
