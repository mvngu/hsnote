...
\item If $ax + b = 0$, then \Expression{eqn:roots_of_axx_bx} is also
  ...
  Substituting the last expression into~\eqref{eqn:roots_of_axx_bx}
  produces
  %%
  \begin{align*}
  \squarebracket*{
...
function~\eqref{eqn:AmazingCar_revenue_function_distributive} is given
...
\item\label{subex:verify_roots_substitution_a5_bminus3_c0}
  Verify the roots from \Part{subex:factorise_a5_bminus3_c0} by
  substituting the roots into $f(x)$ and simplify.

\item\label{subex:verify_roots_quadratic_formula_a5_bminus3_c0}
  Verify the roots from \Part{subex:factorise_a5_bminus3_c0} by using
...
\Theorem{thm:quadratic_function_vertical_intercept_zero}.  However,
...
Let's check your results from \Part{subex:factorise_a5_bminus3_c0} by
...
Use \Theorem{thm:monic_quadratic_roots} to write $g(x)$ as the
expression
%%
\begin{equation}
...
explained in \Part{subeg:monic_quadratic_x2_x5_completing_square}, you
...
\solutionpart{subeg:monic_quadratic_x2_x5_quadratic_formula}
...
\solutionpart{subeg:monic_quadratic_x2_x5_verify}
...
\begin{exercise}
\label{ex:quadratic_roots:given_roots_x1_x2}
...
%%
\begin{equation}
\label{eqn:all_quadratics_with_given_roots}
g(x)
=
\gamma \cdot f(x)
=
...
$g(x)$ as defined in~\eqref{eqn:all_quadratics_with_given_roots} will
have the roots $x = \alpha$ and $x = \beta$.
\end{solution}
}{}

\item\Exercise{ex:quadratic_roots:given_roots_x1_x2} and
  \Problem{prob:given_roots_all_possible_quadratics} show that if you
  ...
  \item\label{subprob:given_roots_x1_x5_point_2_7}
...
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:given_roots_x1_x5}
...
\solutionpart{subprob:given_roots_x1_x5_point_2_7}
From \Part{subprob:given_roots_x1_x5} you know that
...
\item\label{prob:difference_of_two_squares}
  ...
  \item\label{subprob:difference_two_squares_areas_squares}
    \Figure{fig:difference_two_squares} shows a square inside a larger
  ...
  \item\label{subprob:difference_two_squares_area_shaded}
    ...
    \Figure{fig:difference_two_squares}.  Prove that the area of the
    shaded region is the same as the difference $X - A$
    from \Part{subprob:difference_two_squares_areas_squares}.

  \item\label{subprob:difference_two_squares_identity}
    Use \Part{subprob:difference_two_squares_area_shaded} to prove
    that $x^2 - a^2 = (x - a) (x + a)$.  This equality is called the
    \emph{difference of two squares identity}.

  \item\label{subprob:difference_two_squares_repeat_exercise}
    Use \Part{subprob:difference_two_squares_identity} to determine
    the roots of the function from
    \Exercise{ex:factorise_aminus1_c1}.

  \item\label{subprob:difference_two_squares_a_cminus}
...
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:difference_two_squares_areas_squares}
In \Figure{fig:difference_two_squares}, the square whose side length
is $x$ has an area of $x^2$ and the square whose side length is $a$
has an area of $a^2$.  Then you have the difference $x^2 - a^2$.

\solutionpart{subprob:difference_two_squares_area_shaded}
The shaded region in \Figure{fig:difference_two_squares} is made up of
...
%%
\begin{equation}
\label{eqn:difference_two_squares}
\begin{aligned}
(x - a)^2 + 2a(x - a)
&=
...
in \Part{subprob:difference_two_squares_areas_squares}.

\solutionpart{subprob:difference_two_squares_identity}
Using \Part{subprob:difference_two_squares_area_shaded}, in the
...
%%
Equate
\Expressions{eqn:difference_two_squares}{eqn:difference_two_squares_factorised}
to see that $x^2 - a^2 = (x - a) (x + a)$.

\solutionpart{subprob:difference_two_squares_repeat_exercise}
In \Exercise{ex:factorise_aminus1_c1}, you have the quadratic function
...
Use \Part{subprob:difference_two_squares_identity} to write $g(x)$ in
...
\solutionpart{subprob:difference_two_squares_a_cminus}
Factor out the $a$ to get
%%
\begin{align*}
f(x)
...
\]
which is the difference of two squares.
Use \Part{subprob:difference_two_squares_identity} to factorise $f(x)$
as
\[
f(x)
=
...
\item You can use the difference of two squares identity from
  \Problem{prob:difference_of_two_squares} to help you multiply two
  integers.
  %%
  \begin{packedenum}
...
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:difference_two_squares_7_13}
...
\]
Use
\Subproblem{prob:difference_of_two_squares}{subprob:difference_two_squares_identity}
to write
%%
\begin{align*}
7 \times 13
...
\solutionpart{subprob:difference_two_squares_12_18}
...
\item Let $n$ be any integer.
  ...
  \item\label{subprob:difference_two_consecutive_squares}
    Use \Problem{prob:difference_of_two_squares} to prove that
    $(n + 1)^2 - n^2$ is an odd integer.

  \item\label{subprob:difference_two_integer_squares_odd}
    If $k$ is an odd integer, use
    \Problem{prob:difference_of_two_squares} to prove that
    $(n + k)^2 - n^2$ is odd.

  \item\label{subprob:difference_two_integer_squares_even}
    If $k$ is even, prove that $(n + k)^2 - n^2$ is even.
  \end{packedenum}
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:difference_two_consecutive_squares}
...
\solutionpart{subprob:difference_two_integer_squares_odd}
...
\solutionpart{subprob:difference_two_integer_squares_even}
...
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:quadratic_roots:formula_Hindu_perfect_square}
...
\solutionpart{subprob:quadratic_roots:formula_Hindu_multiply_4}
...
b^2 - 4ac.
\]
By \Part{subprob:quadratic_roots:formula_Hindu_perfect_square}, you
...
\item This problem will help you to derive~(again!) the quadratic
  ...
  \item\label{subprob:quadratic_roots:Viete_quadratic_formula}
    ...
    \Expression{eqn:quadratic_roots:Viete_substitution_expand} has the
    roots
    %%
    \begin{equation}
  ...
  \item\label{subprob:quadratic_roots:Viete_quadratic_formula_verify}
    From \Example{eg:completing_square_a3_bminus7_c2}, you know that
    the function $f(x) = 3x^2 - 7x + 2$ has the roots $x_1 = 2$ and
    $x_2 = 1/3$.  Use the
    substitution~\eqref{eqn:quadratic_roots:Viete_substitution} and
    \Expression{eqn:quadratic_roots:Viete_quadratic_formula} to verify
    the given roots of $f(x)$.
  \end{packedenum}
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:quadratic_roots:Viete_ax_square_minus_c}
The roots of $f(x)$ are all values of $x$ such that the expression
$f(x) = 0$ is true.  That is, you want all values of $x$ such that the
...
\solutionpart{subprob:quadratic_roots:Viete_substitution}
...
\solutionpart{subprob:quadratic_roots:Viete_quadratic_formula}
...
\solutionpart{subprob:quadratic_roots:Viete_quadratic_formula_verify}
Use \Equation{eqn:quadratic_roots:Viete_quadratic_formula} to write
\[
y
=
\pm
...
\pm\frac{5}{6}.
\]
Now use \Equation{eqn:quadratic_roots:Viete_substitution} to write
\[
x
=
\pm\frac{5}{6}
...
\ifbool{showSolution}{
\begin{solution}
\solutionpart{subprob:difference_two_squares_reciprocal_product_k}
You can write
\[
1 - \frac{1}{k^2}
=
...
\solutionpart{subprob:difference_two_squares_reciprocal_products}
Use \Part{subprob:difference_two_squares_reciprocal_product_k} to
write
\[
1 - \frac{1}{2^2}
=
