...
$\pi / 2$ radians.  You decide on an integer $k \geq 1$ to be used for
dividing $\degree{90}$.  Then the angle that separates any two
...
\item You draw a pentagon inside a unit circle such that each of the
