...
\tikzexternalize{perpendicular-lines-origin}
...
\newcommand{\genericPoint}{%%
  %% One point.
  \xyPoint{point}{A = \tuple{1}{1}}{above right}
  \draw[dashStyle] (origin) -- (point);
  \path pic["$\degree{45}$",draw,->,thick,angle radius=1.1cm]
  {angle=xyRadius--origin--point};
  %% Another point.
  \xyPoint{pointReflection}{B = \tuple{-1}{1}}{above right}
  \draw[dashStyle] (origin) -- (pointReflection);
  \path pic["$\degree{135}$",above,draw,->,thick,angle radius=1.5cm]
...
\coordinate (pointReflection) at (-\xa,\yb);
