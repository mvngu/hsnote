...
to complete one cycle.  For example,
\Figure{fig:trigonometric:sine_cycle} shows various graphs of $F(x)$
for $c = \triple{\frac{1}{2}}{1}{2}$.  When $c = 1$ you have
$F_1(x) = f(x) = a \sin x + b$, the graph of which requires $2\pi$
...
\begin{exercise}
Consider the cosine function $f(x) = \cos(cx)$, where $x$ represents
time.  Graph the function for
$c = \triple{\frac{1}{2}}{1}{\frac{4}{3}}$, where
$0 \leq x \leq 2\pi$.  When $c = 1$, how long does the graph of $f(x)$
take to complete one cycle?  When $c = \frac{4}{3}$, determine the
amount of time required for the graph of $f(x)$ to complete one
cycle.
\end{exercise}
...
$c = \frac{4}{3}$, the graph of $f(x)$ requires $\frac{3\pi}{2}$ units
of time to complete one cycle.
