...
discriminant.  The discriminant of $f(w)$ is
%%
\begin{align*}
\Delta
&=
...
\end{align*}
%%
This is a positive number so there exists at least one real value of
$w$ that solves \Equation{eqn:rectangular_region_equation}.  Using the
