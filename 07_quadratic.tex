...
\begin{problem}
\item Let $f(x)$ be a quadratic function whose discriminant is zero.
  %%
  \begin{packedenum}
...
\item If $f(x)$ is a quadratic function with positive discriminant,
  prove that $f(x)$ has two different roots.
\ifbool{showSolution}{
\begin{solution}
