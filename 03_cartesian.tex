...
$(\sqrt{2}\comma 0)$ and $\tuple{2}{1}$ is approximately $1.1589$.
\end{solution}
...
\item Let $a$ be a positive number.  An ant starts at the point
...
\item Let $a$ be a positive number.  An ant starts at the origin and
