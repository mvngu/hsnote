...
you determine the values of $a$ and $b$?  Suppose the values of $x$
are evenly spaced and increase by one unit each time as shown in
...
From \Table{tab:function_values_a_2_b_minus_1} you know that the given
...
$\tuple{0}{-1}$ and so $b = -1$.  Therefore the values in
