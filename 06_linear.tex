...
determine the $y$-coordinate of the point of intersection.
...
$g(x)$ to obtain $y = 2 + 3$ and simplifying results in $y = 5$.
Therefore the functions $f(x)$ and $g(x)$ intersect at the point
$\tuple{2}{5}$ and so the lines that represent these two functions are
not parallel.
\end{solution}
