...
\item Let $\quadruple{a}{b}{c}{d} \in \RR$ be known constants.
...
First, you need to know the Cartesian coordinates of the points $A$
and $B$.  The point $A$ makes an angle of $\degree{30}$~(or $\pi / 6$
radians) with respect to the positive half of the $x$-axis.  Since $A$
lies on a unit circle that is centred at the origin, the circle has a
radius of $1$ and so $A$ can be described by the polar coordinates
...
$\tuple{\frac{\sqrt{3}}{2}}{\frac{1}{2}}$.  Similarly, the point $B$
can be described by the polar coordinates $\tuple{1}{\frac{3\pi}{4}}$
because $\degree{135}$ is equivalent to $\frac{3\pi}{4}$ radians.  The
