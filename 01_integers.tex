...
\item Let $n$ be any even integer.  Explain why the square number
  $n^2 = n \times n$ is also an even integer.  Provide another
  explanation of why $n^2$ is even.
\ifbool{showSolution}{
  \begin{solution}
  ...
  square number $n^2$ is also even.  On the other hand, because $n$ is
  even you can write it as $n = 2k$, where $k$ is another integer.
  Then you can use the associative laws to write $n^2$ as
  %%
  \begin{align*}
  n^2
  &=
