...
factorise $f(x)$.  However, let's see whether you can factorise $f(x)$
in a different way.  To understand how this can be accomplished,
consider the function $g(x) = x^2 + bx$ so that you have
%%
\begin{equation}
...
into $g(x)$ and derive a function value of zero.  The examples below
should help to clarify how to use the technique of completing the
square to determine the roots of any quadratic  function.
...
Finally, you check your results.  Substituting the roots of $g(x)$
into $f(x)$ should produce the function value of zero.  Substitute the
root $x_1 = 2$ into $f(x)$ to get
%%
\begin{align*}
f(2)
&=
