...
\Theorem{thm:monic_quadratic_roots} to write $f(x)$ in the completed
square form
%%
\begin{align*}
f(x)
...
Doing so should produce zero as the function value.  Substitute the
...
determine the roots of $f(x) = x^2 - 10x + 21$.
\end{exercise}
