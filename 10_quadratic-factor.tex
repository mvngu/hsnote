...
\end{equation}
%%
First, let's consider the case where $a = 1$.  That is, you want to
write
\[
f(x)
=
...
$\parenthesis*{\frac{b}{c}}^2$.  In other words, adding the area
$\parenthesis*{\frac{b}{c}}^2$ to $g(x)$ would result in the area of
...
\Expression{eqn:completing_square_special_case_squared} to help you
determine the roots of a quadratic function?
