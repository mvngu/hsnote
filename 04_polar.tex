...
\ifbool{showSolution}{
  ...
  the unit circle centred at the origin.  An angle of $\degree{60}$ is
  the same as $\pi / 3$ radians.  Use
  \Equation{eqn:value_of_x_y_on_unit_circle} to write
  $\cos\frac{\pi}{3} = 1 / 2$ and $\sin\frac{\pi}{3} = \sqrt{3} / 2$.
  Note also that if $k \geq 0$ is an integer, then the radians
  \[
  \frac{\pi}{3} + 2k\pi
  =
  \frac{\pi}{3}
