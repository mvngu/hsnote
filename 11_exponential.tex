...
Let $t$ be the number of doubling.  Use
\Theorem{thm:exponential:exponential_growth} to write the population $Q(t)$ after
$t$ doublings as
%%
\begin{equation}
...
would have undergone $12$ doublings.  \Figure{fig:exponential:ecoli_growth} shows
