...
\caption{%%
  ...
  Prior to the measurement of radioactive decay, the sample was
  neutron activated for $30$ minutes.  The experiment was performed by
  Steven Sahyun of the University of Wisconsin at Whitewater, USA on
  $13$-th January~$2005$.  Time is measured in seconds.  After the
  elapse of a given number of seconds, a Geiger counter was used to
  measure the number of remaining radioactive isotopes in the sample.
}
...
\item In many situations, the exponential growth model as described
  ...
  $t$, the population number can be written as the logistic equation
  %%
  \begin{equation}
