...
the amount of fermium-$250$ remains.
...
after $t$ units of time, use
\Theorem{thm:exponential:exponential_decay} to write
$A(t) = 100 \times 0.5^t$.  Let's use the latter formula to verify the
results from \Part{subex:exponential:fermium250_30minutes_60minutes}.
The time of $t = 1$ translates to $30$ minutes so at time $t = 1$ you
would have
\[
A(1)
=
