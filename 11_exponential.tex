...
error of $\text{RMSE} \approx 1.7989$ from using
\Equation{eqn:exponential:MnM_probability_model} to predict the number
of remaining M\&M's.  Such a relatively low value of the RMSE
indicates that \Equation{eqn:exponential:MnM_probability_model} is
