...
\item Binary numbers.  How many possible non-negative integers with
  $n$ bits?  How many possible subsets of a set with $n$ elements?
\ifbool{showSolution}{
\begin{solution}
...
\item Formula for Newton's law of cooling involving the number
  $e$.\footnote{
...
\item Benford's law.  Graph looks like an exponential decay, but
  really isn't.
\ifbool{showSolution}{
\begin{solution}
