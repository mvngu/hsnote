...
\caption{%%
  The radioactive decay of a sample of aluminium.  The experiment was
  performed by Steven Sahyun of the University of Wisconsin at
  Whitewater, USA.  Time is measured in seconds.  After the elapse of
  a given number of seconds, a Geiger counter was used to measure the
  number of remaining radioactive isotopes in the sample of
  aluminium.
}
