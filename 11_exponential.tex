...
approximately the same in the second decimal digits.  You can conclude
...
of the data seems to show an exponential-like growth, that you can
...
\Equation{eqn:exponential:frond_numbers_Ashby_formula}, both numbers
...
\item\label{prob:exponential:radioactive_dice}
  ...
  \item\label{subprob:exponential:radioactive_dice_simulation_roll_dice}
    ...
    second argument \code{decay\_state} specifies the number of pips
    that indicates the ``decay'' state of a die.  The purpose of the
    function \code{roll\_dice()} is to roll the given number of dice
  ...
  \item\label{subprob:exponential:radioactive_dice_error_analysis}
    ...
    graphs on one set of axes.  What do you notice?  Use the root mean
    square error to help you explain which one of the above three
    functions is better than the other two at modelling your
    experimental data.
  \end{packedenum}
\ifbool{showSolution}{
\begin{solution}
