...
\caption{%%
  ...
  J.~G.~Speight. \emph{Lange's Handbook of Chemistry}. 16-th edition,
  McGraw-Hill, 2005, pp.1.224--1.225.
}
...
\item In many situations, the exponential growth model as described
  ...
  \item\label{subprob:yeast_logistic}
    ...
    RMS error), explain which of the equations
