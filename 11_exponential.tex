...
would like the interest to be as high as possible and the time between
each interest calculation to be as short as possible.  When you take
out a loan, interest is calculated on the amount you still have to
pay.  In this case, you want the interest rate to be as low as
possible and the time between interest calculation to be as long as
possible.
...
\item\label{subeg:savings_6months_growth_rate}
  ...
  factor of your savings account.
...
\item\label{subeg:savings_6months_balance_formula}
  ...
  compounding periods.  Use the formula to verify your results
  from \Part{subeg:savings_6months_balance_first_year}.  Produce a
  graph of the balance of your account within the first two years
  since you opened the account.

\item\label{subeg:savings_6months_doubling_time}
  Estimate the doubling time of your savings account.
\end{packedenum}
\end{example}
...
balance of the savings account over a period of two years.

\begin{figure}[!htbp]
\centering
\includegraphics[scale=1.1]{image/11/interest-half-yearly.pdf}
\caption{%%
  The balance of a savings account over a period of two years.  The
