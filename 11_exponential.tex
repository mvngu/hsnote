...
\item\emph{Billionaire Fry.}
  In episode~6, season~1 of \emph{Futurama}~(1999), Fry learnt that
  due to compound interest his account balance had grown to billions
  of dollars.  You can watch the relevant clip at:
  ...
  current account balance, rounded to the nearest cent.  Estimate the
  doubling time of Fry's account balance.  If the interest on Fry's
  account had been continuously compounded, what would Fry's account
  balance be at the end of the given number of compounding years?
\ifbool{showSolution}{
\begin{solution}
...
\caption{%%
  ...
  allowed to grow.  The ``Observed'' column lists the counts of the
