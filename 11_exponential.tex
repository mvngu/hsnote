...
\item\label{prob:duckweeds}
  ...
  \item\label{subprob:duckweeds_error_analysis}
    ...
    \Table{tab:duckweed_frond12_missing}, calculate the error that
    results from using your formula
...
\item Suppose you put water in a container and then seal the
  ...
  \item\label{subprob:vapour_pressure_RMS_error}
    ...
    \Table{tab:water_vapour_pressure}, calculate the error that
    results from using each of
