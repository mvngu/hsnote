...
dollars.  You can watch the relevant clip at:
%%
\begin{center}
\url{https://youtu.be/f2Wi6AoArV0}
\end{center}
%%
Determine the initial balance of Fry's account, the annual growth rate
of the account balance, and the number of years for which the balance
had been left to grow.  Determine the formula that the bank teller
used to approximate Fry's current account balance and use the formula
to calculate Fry's current account balance, rounded to the nearest
cent.  Estimate the doubling time of Fry's account balance.  If the
interest on Fry's account had been continuously compounded, what would
Fry's account balance be at the end of the given number of compounding
years?
\end{exercise}
...
to grow for $1000$ years.  The bank teller used the following formula
to approximate Fry's account balance:
\[
B(t)
=
0.93 \times 1.0225^t
...
$4.3$ billion dollars.  The rule of $72$ tells you that the doubling
time of Fry's account balance is approximately $72 / 2.25 = 32$
years.  Note that twice the initial balance is
$2 \times 0.93 = 1.86$ dollars.  After $t = 32$ years, Fry's account
balance would be
\[
B(32)
=
...
doubling time on Fry's account balance is at most $32$ years.  If
interest had been continuously compounded, Fry's account balance at
...
\item\label{prob:radioactive_dice}
  ...
  \item\label{subprob:radioactive_dice_error_analysis}
    ...
    functions is better than the other two at modelling the data in
