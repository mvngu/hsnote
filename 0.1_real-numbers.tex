...
If $\triple{a}{b}{c}$ are any numbers, then you can write:
%%
...
Now let's put the associative laws to some good use.
...
$n = 2k$ and $r = 2s$, where $k$ and $s$ are integers.  Then the
product $nr$ can be written as
%%
\begin{align*}
nr
&=
