...
\item A right-angled triangle has a base and height of lengths $b > 0$
  and $b + 1$ units, respectively.  Suppose the hypotenuse has a
  length of $b + 2$ units.
  %%
  \begin{packedenum}
...
should be a right-triangle whose base has length $b$ units, whose
height is $b + 1$ units, and the hypotenuse has a length of $b + 2$
units.  To calculate a value of $b$ that satisfies the above
...
height of the triangle has a length of $b + 1 = 4$ units and the
hypotenuse has a length of $b + 2 = 5$ units.
\end{solution}
}{}
\end{problem}
