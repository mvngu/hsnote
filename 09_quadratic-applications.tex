...
\item A right-angled triangle has a base and height of $b$ and $b + 1$
  metres, respectively.  Suppose the hypotenuse has a length of
  $b + 2$ metres.
  %%
  \begin{packedenum}
...
\item\emph{Orbital period.}
  ...
  \item\label{subprob:planetary_orbit_RMS_error}
    ...
    the orbital periods given in \Table{tab:planet_distance_to_Sun},
...
\Equation{eqn:Earth_days_orbit_Kepler} is approximately $132.9641$,
