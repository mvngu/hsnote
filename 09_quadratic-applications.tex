...
\item In the Solar System, the distance from any planet to the Sun is
  ...
  \item\label{subprob:planetary_orbit_comparison}
    ...
    from \Parts{subprob:planetary_orbit_quadratic}{subprob:planetary_orbit_Kepler},
    explain which of the
    \Equations{eqn:Earth_days_orbit_approximation}{eqn:Earth_days_orbit_Kepler}
    provides a better approximation to the exact orbital periods of
    the given planets.
  \end{packedenum}
\ifbool{showSolution}{
\begin{solution}
...
in.  As can be seen from \Table{tab:planet_orbital_periods}, Kepler's
\Formula{eqn:Earth_days_orbit_Kepler} generally provides a better
approximation of the orbital periods than
\Equation{eqn:Earth_days_orbit_approximation}, except for the planets
Uranus and Neptune.
