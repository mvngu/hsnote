...
\item In the Solar System, the distance from any planet to the Sun is
  ...
  \item\label{subprob:planetary_orbit_comparison}
    ...
    value.  In this case, an \emph{observed value} is an exact value
    of an orbital period as given in
    \Table{tab:planet_distance_to_Sun} and a \emph{predicted value} is
    a value of the orbital period as calculated by some function.  Let
    $\tuple{d}{p}$ be a data point from
