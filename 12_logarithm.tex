...
\Example{eg:logarithm:hinoki_cypress_tree} below clarifies the above
technique of logarithmic regression.
...
\item\label{subeg:logarithm:shortleaf_Pearson_r_RMS_error}
  Calculate the Pearson correlation coefficient $\rho$ and root mean
...
The model~\eqref{eqn:logarithm:shortleaf_volume} has a Pearson
correlation coefficient of $\rho \approx 0.9867$ and a root mean
square~(RMS) error of approximately $5.7532$.  The high value of
$\rho$ and the low value of the RMS error both suggest that
