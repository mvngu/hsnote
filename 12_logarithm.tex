...
logarithm.  Note that \Equation{eqn:log10_100} uses the common
logarithm because the base is $10$.  The right-hand side of
\Equation{eqn:log10_100} simplifies to $x$ due to the next theorem.
...
t.
\]
The latter expression evaluates to approximately $t = 12.2392$,
