...
Let's consider a data set that can be used to perform logarithmic
regression.  \Table{tab:logarithm:shortleaf} lists the diameter~(inch)
versus volume~(cubic feet) of $70$ shortleaf pine trees.\footnote{
