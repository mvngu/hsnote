...
of $x$ such that $\log_{10} x$ evaluates to $1 / 2$.  You can
use \Part{subthm:logarithm:cancellation_property_exponential_log} of
\Theorem{thm:logarithm:cancellation_property} and consider both sides
of $\log_{10} x = \frac{1}{2}$ as exponents of the base $10$.  Then
...
\sqrt{10}.
\]
The left-hand side simplifies to $x$.  The equation now becomes
$x = \sqrt{10}$.
\end{solution}
...
2^5
\]
which by \Part{subthm:logarithm:cancellation_property_exponential_log}
of \Theorem{thm:logarithm:cancellation_property} simplifies to
$x = 2^5 = 32$.
\end{solution}
}{}
...
\]
Use \Part{subthm:logarithm:cancellation_property_exponential_log} of
\Theorem{thm:logarithm:cancellation_property} to simplify the last
equation to $2x = e^3$, which upon solving for $x$ yields
$x = \frac{1}{2} e^3$.
\end{solution}
}{}
...
\begin{proof}
Use \Part{subthm:logarithm:cancellation_property_exponential_log} of
\Theorem{thm:logarithm:cancellation_property} to write
$b^{\log_b x} = x$.  Take the logarithm to base $k$ of both sides and
you end up with
$\log_k \parenthesis*{b^{\log_b x}} = \log_k x$, which
by \Part{thm:logarithm:properties_multiplication} of
\Theorem{thm:logarithm:properties} can also be written as
\[
\log_b x \times \log_k b
=
\log_k x.
\]
