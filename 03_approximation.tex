...
line.  What if you have a pair $\tuple{x}{y}$ of real numbers?  How
would $\tuple{x}{y}$ be represented as a point on the number line?

\begin{figure}[!htbp]
\centering
\includegraphics[scale=1]{image/03/number-line.pdf}
\caption{%%
